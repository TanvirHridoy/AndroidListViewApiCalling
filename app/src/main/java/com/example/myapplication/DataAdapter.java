...
public class DataAdapter extends ArrayAdapter<TicketModel.Ticket> {
    private Context mContext;
    private int mResources;
    public DataAdapter(@NonNull Context context, int resource, @NonNull ArrayList<TicketModel.Ticket> objects) {
